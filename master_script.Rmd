...
ggplot(poll_plot_data,
  ...
  theme_devpublicopinion +
  labs(title = "Polling for each country",
       subtitle = "% vote share, point for each traditional polling collected by country; polls included in this figure are indicative, not exhaustive",
       x = NULL,
       y = "%, vote share")
...
```{r plot-estimates-vs-polls-and-elex}
