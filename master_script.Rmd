...
gpw_context_raw <- read_stars("data/gpw_quality//gpw-v4-data-quality-indicators-rev11_context_30_min_tif/gpw_v4_data_quality_indicators_rev11_context_30_min.tif", proxy = FALSE)
gpw_mean_raw <- read_stars("data/gpw_quality/gpw-v4-data-quality-indicators-rev11_mean_adminunitarea_30_min_tif/gpw_v4_data_quality_indicators_rev11_mean_adminunitarea_30_min.tif", proxy = FALSE)
...
###### Data quality
ggplot() +
  geom_sf(data = gaul1_raw) +
  coord_sf(xlim = c(1, 100), ylim = c(1, 100), expand = FALSE)
