...
# Testing
# get_tweets("Buhari", "en", "9.083333333,7.533333,20km",  20, "2020-01-01", "2020-01-05",
#            "test.json", "193.56.255.180", as.integer(3128), "http")
...
get_help %>%
  ...
  mutate(tweets = pmap(list(leader, geocode, date, date_plus_one, country, proxy, port, proxy_type),
                       ~get_tweets(..1,
                                   "en",
                                   ..2,
                                   20,
