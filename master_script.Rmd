...
# Predict
estimates_master <- test_master_2 %>%
  add_predictions(., .$model)

map(test_master)
  
  mutate(prediction = predict(model, ., allow.new.levels = TRUE))


mutate(prediction = map2(model, data, ~predict(.x, .y, allow.new.levels = TRUE)))
