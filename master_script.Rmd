...
nga_shp_raw <- readOGR(dsn = "data/gpw_admin/gpw-v4-admin-unit-center-points-population-estimates-rev11_nga_shp/",
                       layer = "gpw_v4_admin_unit_center_points_population_estimates_rev11_nga")
...
ne_raw <- readOGR(dsn = "data/ne_50m_admin_0_countries/",
...
gpw_30_ext %>% filter(admin == "Nigeria")
...
ggplot() +
  ...
  geom_sf(data = pop_30, alpha = 0.5) + # GPW areas
  coord_sf(xlim = c(2.5, 30), ylim = c(4, 30), expand = FALSE) +
